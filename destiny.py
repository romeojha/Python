...
if play == 'play':
    ...
    if enter == 'y':
        print('''
                            ...
                            |..|   |..| ''')
        r_or_left = input(
            "you are at the start point(look given map for reference).\nyou have handful of foods to survive on this journey\n\n Take 'left' or 'right'?")
        if r_or_left == 'right':
            print("you reached New castle after a day.")
            print('''
...
''')
            ...
            if enter == 'y':
                ...
                if r_or_left == 'left':
                    print("you travelled for two days to reach the beach")
                    print('''
        ... ....                     .. ...           
  .. ...... .                           ........__    
...                                      ......|__|   
...
''')
                        ...
                        if enter == 'y':
                            print(
                                "you are hungry.after some time,you found three way and three boards. straight says'4days' left says'3days' right says'5days'")
                            threeway = input(
              ...
              \               /
               \    _____    /
                ...
                |--\_|_//--|
                        ...
                        print(
                            "you went to swimming to get the nearest boat and died by poision")
                    elif s_t_b == 'brokenhill':
                        print(
                            'it took 4 days to reach broken hill.\nnothing in broken hill. your only option is to return')
                ...
                if R_or_L == 'right':
                    ...
                    print(
                        "you choose right path but you are starving after 45hours and cannot survive this game.\nyou will die soon")
        else:
            print("you died. Hash kiled you ")
    else:
        print("you quit, you cannot try again")
else:
    print("you quit, you cannot try again")
